...
dir_cmaq ='/projects/b1045/wrf-cmaq/output/CONUS4K/output_CONUS4K_d02_no_RWC_4km_sf_rrtmg_10_10_1_v3852/postprocess/'
...
for v in range(len(var)):
    ...
    final_df.to_csv(dir_epa + var[v] + '_' + domain + '_' + str(year) + '_' + str(mo) + '_EPA_CMAQ_Combine_no_RWC.csv')
    print('done ' + var[v])
